...
class WeatherPictogram(
    ...
    fun getAlternatePictogram(): Int {
        return alternativeIconMapping[code] ?: R.raw.not_available
    }

    private fun getAlternatePictogram(currH: Int, riseH: Int, setH: Int): Int {
        return alternativeIconMapping[code.mod(1000) + (if (currH in (riseH + 1)..setH) 1000 else 2000)] ?: R.raw.not_available
    }
